...
let ProductService = class ProductService {
    ...
    async getAllProducts() {
        ...
        return productsDb.map((product) => new product_1.Product(product.id, product.name, product.price));
    }
    async getProductById(productId) {
        ...
        return new product_1.Product(productDb.id, productDb.name, productDb.price);
    }
